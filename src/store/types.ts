...
export type AppDispatch<A extends Action = Action> = ThunkDispatch<
    RootState,
    unknown,
    A
>;
...
export type AppReducer<T extends object, A extends Action = Action> = (
    state: T,
    action: A
) => T;
...
export type AppReducerStateType<T extends AppReducer<any, any>> =
    T extends AppReducer<infer R, any> ? R : any;
